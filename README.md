# Programas de estructuras condicionales en Python

**Nombre:** Yarlei Aldahir Luna Dimas  
**Número de control:** 24150423

## Descripción de los programas

1. **Clasificación de triángulos:** solicita tres lados y determina si el triángulo es equilátero, isósceles o escaleno.
2. **Año bisiesto:** solicita un año y determina si es bisiesto utilizando las reglas de divisibilidad entre 4, 100 y 400.
3. **Conversor de calificaciones:** convierte una calificación de 0 a 100 en una letra de A a F.
4. **Comparación de tres números:** solicita tres números y muestra cuál es el mayor y cuál es el menor.
